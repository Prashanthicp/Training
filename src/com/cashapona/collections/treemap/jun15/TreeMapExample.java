package com.cashapona.collections.treemap.jun15;

//Java Program to Illustrate Operations in TreeMap
//Such as Creation, insertion searching, and traversal
...
public class TreeMapExample {
	...
	static void insert() {
		...
		// using put() method
		tree_map.put(10, "Cashapona");
		tree_map.put(15, "4");
		tree_map.put(20, "Cashapona");
	...
	public static void main(String[] args) {
		...
		// Search value "Cashapona" in the TreeMap
		search("Cashapona");
