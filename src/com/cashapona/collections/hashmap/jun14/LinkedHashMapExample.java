...
public class LinkedHashMapExample {
	...
	public static void main(String a[]) {
		...
		lhm.put("one", "practice.cashapona.org");
		lhm.put("two", "code.cashapona.org");
		lhm.put("three", "training.cashapona.org");
		...
		System.out.println("Contains value 'practice.casha" + "pona.org'? "
				+ lhm.containsValue("practice" + ".cashapona.org"));
