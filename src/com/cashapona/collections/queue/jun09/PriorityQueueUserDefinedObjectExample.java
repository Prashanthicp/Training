...
public class PriorityQueueUserDefinedObjectExample {
	public static void main(String[] args) {
		...
		employeePriorityQueue.add(new Employee("Ramya", 100000.00));
		employeePriorityQueue.add(new Employee("Ektha", 145000.00));
		employeePriorityQueue.add(new Employee("Sravani", 115000.00));
		employeePriorityQueue.add(new Employee("Yamini", 167000.00));
